...
console.log(JSON.stringify({ schemaVersion: 1, status: result.exitCode === 0 ? 'unexpected_pass' : 'expected_failed', mode: 'intentional-unimplemented-fixture', exitCode: result.exitCode, output: output.length > 1_000 ? `${output.slice(0, 1_000)}…` : output }));
