...
const updated = await updateTask(file, 'o-100', 'running', before.version);
console.log(JSON.stringify({ version: updated.version, task: updated.tasks.find((task) => task.id === 'o-100') }, null, 2));
